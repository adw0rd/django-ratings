...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Score.score_with_vote_weight'
        db.add_column('djangoratings_score', 'score_with_vote_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Score.score_with_vote_weight'
        db.delete_column('djangoratings_score', 'score_with_vote_weight')
    ...
    models = {
        ...
        'djangoratings.score': {
            ...
            'score_with_vote_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
